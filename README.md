...
| Spark 4.0.x compatible connector | `com.microsoft.azure:spark-mssql-connector_2.12:1.5.0` | 2.12          | # || --OCM || --UCID=[Mohammed Khan] --userid=[ayan980801] --DSC=[Fork Update Spark 4.0 Support]
